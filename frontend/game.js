...
import { CELL, GRID_H, GRID_W, syncTileCatalogFromApiTiles } from "./constants.js";
...
import { drawSandTile, drawLavaTile, drawCustomTile } from "./tileRenderer.js";
import { drawTileCell, createPlayDrawBag } from "./tileDrawing.js";
...
class GameRenderer {
    ...
    _drawTileDetail(ctx, tid, x, y, sz) {
        if (!this._playDrawBag) this._playDrawBag = createPlayDrawBag(this);
        drawTileCell(ctx, this._playDrawBag, tid, x, y, sz);
    }
